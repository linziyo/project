...
<script type="text/javascript">
    $(function () {
        $("input[type=checkbox][name=past_history_operation]").first().change(function () {
            $("input[type=checkbox][name=past_history_operation]").not("input[type=checkbox][name=past_history_operation]:first").prop('checked', false);
        });
    });
</script>
@endpush