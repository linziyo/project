...
<script type="text/javascript">
    $(function () {
        $("input[type=checkbox][name=past_history_injury]").first().change(function () {
            $("input[type=checkbox][name=past_history_injury]").not("input[type=checkbox][name=past_history_injury]:first").prop('checked', false);
        });
    });
</script>
@endpush