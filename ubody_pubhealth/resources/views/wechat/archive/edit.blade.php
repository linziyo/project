...
@section('wechat_content')
    <form action="{{ URL::action('Wechat\ArchiveController@update', $model->id) }}" method="post"
          onsubmit="return submitForm(this)">
        <input type="hidden" id="community_id" name="community_id" value="{{ $model->id }}"/>
            ...
            <label id="actionDisabilityHistory" class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input type="text" id="disability_history" name="disability_history" class="weui-input" readonly
                           value="{{ $model->disability_history }}"/>
                </div>
                <div class="weui-cell__ft">
                    <i class="weui-icon-warn"></i>
                </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function submitForm(form) {
            ...
            $.ajax({
                url: '{{ URL::action('Wechat\ArchiveController@update', $model->id) }}',
                data: {
