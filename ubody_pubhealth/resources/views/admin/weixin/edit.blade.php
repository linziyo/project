<form class="form" action="{{URL::action('Admin\\AdminController@update', $model->id)}}">
    {{csrf_field()}}
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="price" name="price" placeholder="建议价格" value="{{ $model->price }}"/>
            <span class="help-block"></span>
        </div>
    </div>
