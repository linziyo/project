<form class="form" action="{{URL::action('Admin\\TenantController@store')}}" method="POST" enctype="multipart/form-data">
    {{csrf_field()}}
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            {!! Form::text('name', '', ['id'=>'name','class'=>'form-control','placeholder'=>'租户名称']) !!}
            <span class="help-block"></span>
        </div>
        <div class="form-group">
            {!! Form::label('full_name', '租户全称', ['class'=>'control-label']) !!}
            {!! Form::text('full_name', '', ['id'=>'full_name','class'=>'form-control','placeholder'=>'租户全称']) !!}
            <span class="help-block"></span>
        </div>
        <div class="form-group">
            {!! Form::label('contact_name', '联系人姓名', ['class'=>'control-label']) !!}
            {!! Form::text('contact_name', '', ['id'=>'contact_name','class'=>'form-control','placeholder'=>'联系人姓名']) !!}
            <span class="help-block"></span>
        </div>
        <div class="form-group">
