<form class="form" action="{{URL::action('Admin\\DoctorController@update', $model->id)}}" method="post" enctype="multipart/form-data">
    <input type="hidden" name="_method" value="PUT"/>
    <input type="hidden" name="tenant_id" value="{{$model->tenant_id}}"/>
    <input type="hidden" name="user_id" value="{{$model->user_id}}" id="user_id"/>
    {{csrf_field()}}
    ...
    <div class="modal-body">
        <div class="form-group">
            <label class="control-label" for="community_hospital_id">社区医院</label>
        ...
        <div class="form-group">
            ...
            {!! Form::text('duty', $model->duty , ['id'=>'duty','class'=>'form-control','placeholder'=>'职务']) !!}
            <span class="help-block"></span>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            {!! Form::textarea('description', $model->description, ['id'=>'description','class'=>'form-control','placeholder'=>'医生介绍']) !!}
            <span class="help-block"></span>
        </div>
