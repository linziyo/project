            ...
            <div class="container">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 healthy" style="margin-top:6px;">
                        <label class="label_color">{!! Form::radio('visited_type', 1, $model->visited_type == 1 ) !!} &nbsp;门诊 </label>&nbsp;&nbsp;&nbsp;
                        <label class="label_color">{!! Form::radio('visited_type', 2, $model->visited_type == 2 ) !!} &nbsp;家庭 </label>&nbsp;&nbsp;&nbsp;
                        <label class="label_color">{!! Form::radio('visited_type', 3, $model->visited_type == 3 ) !!} &nbsp;电话 </label>&nbsp;&nbsp;&nbsp;
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 healthy" style="margin-top:6px;">
                        <label class="label_color">{!! Form::radio('visit_classification', 1, $model->hypoglycemia_reaction == 1) !!} &nbsp;控制满意 </label>&nbsp;&nbsp;&nbsp;
                        <label class="label_color">{!! Form::radio('visit_classification', 2, $model->hypoglycemia_reaction == 2) !!} &nbsp;控制不满意 </label>&nbsp;&nbsp;&nbsp;
                        <label class="label_color">{!! Form::radio('visit_classification', 3, $model->hypoglycemia_reaction == 3) !!} &nbsp;不良反 </label>&nbsp;&nbsp;&nbsp;
                        <label class="label_color">{!! Form::radio('visit_classification', 4, $model->hypoglycemia_reaction == 4) !!} &nbsp;并发症 </label>&nbsp;&nbsp;&nbsp;
            ...
            $("#formArchive").validate({
                ...
                submitHandler: function (form) {
                    var postData = {
                        ...
                        'visited_type': $("input[name=visited_type]:checked").val(),
                        'symptoms': $("input[name=symptom]:checked").map(function (index, element) {
