...
@section('tenant_content')
    <div class="box box-primary">
        <div class="box-header">
            <form action="{{ URL::action("Admin\\VisitMentalPatientsController@index",'tenant_id='.$tenant['id']) }}" method="post" class="form-inline">
                <input type="hidden" name="tenant_id" value="{{$tenant["id"]}}"/>
                <div class="form-group">

                    <a href="{{ URL::action("Admin\\VisitMentalPatientsController@create",'tenant_id='.$tenant['id']) }}" data-toggle="modal" data-target="#ajax" class="btn btn-primary pull-block">添加</a>
                </div>
                <div class="form-group">
                ...
                @foreach($list as $model)
                    <tr>
                        ...
                        <td style="text-align: right">
                            <a href="{{ URL::action("Admin\\VisitMentalPatientsController@edit", $model->id) }}" data-toggle="modal"
                               data-target="#ajax"
                               class="btn btn-success btn-xs">编辑</a>
                            <a href="{{ URL::action("Admin\\VisitMentalPatientsController@destroy", $model->id) }}"
