	...
	<div class="box box-primary">
			...
			<div class="container">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<div class="input-group date">
							{!! Form::text('death_at', null, ['id'=>'death_at','class'=>'form-control','placeholder'=>'请输入出生日期', 'readonly'=>'true']) !!}
							<div class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</div>
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 healthy" style="margin-top:6px;">
						<label class="label_color">{!! Form::checkbox('symptom', 1, false) !!} 幻觉</label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('symptom', 2, false) !!} 交流困难</label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('symptom', 3, false) !!} 猜疑</label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('symptom', 4, false) !!} 喜怒无常</label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('symptom', 5, false) !!} 行为怪异</label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('symptom', 6, false) !!} 兴奋话多</label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('symptom', 7, false) !!} 伤人毁物</label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('symptom', 8, false) !!} 悲观厌世</label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('symptom', 9, false) !!} 无故外走</label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('symptom', 10, false) !!} 自语自笑</label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('symptom', 11, false) !!} 孤僻懒散</label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('symptom', 12, false) !!} 其他</label>&nbsp;&nbsp;&nbsp;
						<input type="text" class="form-control text_long" name="symptom_content" placeholder="请输入其他" disabled="disabled" />
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group" id="dangerous">
					...
					<div class="col-sm-10 healthy ">
						...
						<input type="text" class="form-control text_long ml15" name="minor_trouble_content" placeholder="请输入轻度滋事 " disabled="disabled"><span>&nbsp;次</span>
					</div>
					<div class="col-sm-2"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 healthy" style="margin-top:6px;">
						...
						<div class="col-sm-5" style="padding-left: 0;">
							<div class="input-group date">
								{!! Form::text('hospital_date', null, ['id'=>'hospital_date','class'=>'form-control','placeholder'=>'请输入住院日期', 'readonly'=>'true']) !!}
								<div class="input-group-addon">
									<i class="fa fa-calendar"></i>
								</div>
							</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<label class="label_color">
							<input class="form-control" placeholder="请输入有哪些药物不良反应" name="laboratory_examination_content" type="text" disabled="disabled">
						</label>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4 healthy pddright0">
						{!! Form::text('referral_reason', null, ['id'=>'referral_reason','class'=>'form-control', 'placeholder'=>'请输入转诊原因' ]) !!}
					</div>
					<div class="col-sm-4 healthy pddright0">
						...
						<div class="row">
							...
							<div class="col-md-2">
								<button type="button" class="btn btn-default btn-flat btn-block append"
										data-source="#tplOperation" data-target="#medicationSituationWrapper"> 添加
								</button>
							</div>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div id="medicationInstructionWrapper" class="col-md-10">
						<div class="row">
							<div class="col-sm-3">
								<input type="text" class="form-control" name="medications_name" id="medications_name" placeholder="请输入药物名称 " />
							</div>
							<div class="col-sm-3">
								<input type="text" class="form-control text_long ml15" name="medications_time" id="medications_time" placeholder="请输入用法用量每日多少次 " />
							</div>
							<div class="col-sm-3">
								<input type="text" class="form-control" name="medications_dosage" id="medications_dosage" placeholder="请输入用法用量每日多少" />
							</div>
							<div class="col-md-2">
								<button type="button" class="btn btn-default btn-flat btn-block append"
										data-source="#tplOperations" data-target="#medicationInstructionWrapper"> 添加
								</button>
							</div>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 healthy" style="margin-top:6px;">
						<label class="label_color">{!! Form::checkbox('rehabilitation_measures', 1, false) !!}&nbsp;生活劳动能力 </label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('rehabilitation_measures', 2, false) !!}&nbsp;职业训练 </label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('rehabilitation_measures', 3, false) !!}&nbsp;学习能力 </label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('rehabilitation_measures', 4, false) !!}&nbsp;社会交往 </label>&nbsp;&nbsp;&nbsp;
						<label class="label_color">{!! Form::checkbox('rehabilitation_measures', 5, false) !!}&nbsp;其他 </label>&nbsp;&nbsp;&nbsp;<br />
						<input type="text" class="form-control text_long mt10" name="rehabilitation_measures_content" disabled="disabled" id="" placeholder="请输入其他康复措施" />
					</div>
					<div class="clear"></div>
				</div>
				<div class="form-group">
...
@section('js')
	...
	<script type="text/javascript">
        ...
        $(function () {
            $("#dangerous").find('.healthy').map(function (index, element) {
                if($(this).is(":checked")){
                    var value = $("input[name=minor_trouble]").eq(index).val();
                    var content = $("input[name=minor_trouble_content]").eq(index).val();
                    alert(value);
                    alert(content);
                }
//                return {
//                    'dangerous_act': $(this).find("input[name=dangerous_act]").val(),
//                    'dangerous_act_content': $(this).find("input[name=dangerous_act_content]").val()
//                };
            });
            ...
            $("#formArchive").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.post("{{ URL::action('Tenant\VisitMentalPatientController@store') }}", postData, function(data){
                        if(data.errorCode == 0){
