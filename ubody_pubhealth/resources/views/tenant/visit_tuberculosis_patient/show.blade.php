            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <label class="label_color">
                        {!! Form::radio('supervisory_staff', 1, ($data['supervisory_staff'] == 1), ['data-rule-required'=>'true', 'data-msg-required'=>'请填写督导人员.', 'id'=>'supervisory_staff', 'aria-required'=>'true']) !!}&nbsp;医生
                    </label>&nbsp;&nbsp;&nbsp;
                    <label class="label_color">
                        {!! Form::radio('supervisory_staff', 2, ($data['supervisory_staff'] == 2), ['data-rule-required'=>'true', 'data-msg-required'=>'请填写督导人员.', 'id'=>'supervisory_staff', 'aria-required'=>'true']) !!}&nbsp;家属
                    </label>&nbsp;&nbsp;&nbsp;
                    <label class="label_color">
                        {!! Form::radio('supervisory_staff', 3, ($data['supervisory_staff'] == 3), ['data-rule-required'=>'true', 'data-msg-required'=>'请填写督导人员.', 'id'=>'supervisory_staff', 'aria-required'=>'true']) !!}&nbsp;自服药
                    </label>&nbsp;&nbsp;&nbsp;
                    <label class="label_color">
                        {!! Form::radio('supervisory_staff', 4, ($data['supervisory_staff'] == 4), ['data-rule-required'=>'true', 'data-msg-required'=>'请填写督导人员.', 'id'=>'supervisory_staff', 'aria-required'=>'true']) !!}&nbsp;其他
                    </label>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 healthy pddright0">
                    {!! Form::text('referral_reasons',$data['referral']['referral_reasons'],
                                    ['data-rule-required'=>'true','data-msg-required'=>'请填写转诊原因.','classs'=>'form-control','id'=>'referral_reasons','placeholder'=>'请输入转诊原因']) !!}
                </div>
                <div class="col-sm-1 healthy pddleft0">
                    <span class="mt10"></span>
                </div>
