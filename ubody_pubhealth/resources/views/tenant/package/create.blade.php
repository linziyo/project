{!! Form::open(['action'=>'Tenant\\PackageController@store', 'id'=>'create_package_form']) !!}
{!! Form::hidden('community_hospital_id',(isset($input['community_hospital_id'])?$input['community_hospital_id']:0),['id'=>'community_hospital_id']) !!}
    <div class=" modal-header">
        ...
        <h4 class="modal-title">创建服务包信息</h4>
    </div>
    <div class="modal-body">
        <div class="form-group">
            {!! Form::label('name','服务包名称',['class'=>'control-label']) !!}
            {!! Form::text('name','',['id'=>'name','class'=>'form-control','placeholder'=>'服务包名称']) !!}
...
<script type="text/javascript">
    $('#create_package_form').validate({onkeyup: false});
</script>