        ...
        <div class="box-header">
            <form class="form-inline" method="get" action="{{ URL::action("Tenant\\ArticleController@index") }}">
                <div class="form-group">
                    <a href="{{ URL::action("Tenant\\ArticleController@create") }}" data-toggle="modal" data-target="#ajax"
                ...
                @foreach($list as $model)
                    <tr>
                        ...
                        <td style="text-align: right">
                            <a href="{{ URL::action("Tenant\\ArticleController@edit", $model->id) }}" data-toggle="modal" data-target="#ajax"
                               class="btn btn-success btn-xs">编辑</a>
                            <a href="{{ URL::action("Tenant\\ArticleController@destroy", $model->id) }}"
