<script type="text/template" id="kid_month_72">
    @include('tenant.visit_kid._guide_large')
</script>

<script type="text/template" id="kids_month_72">
    ...
    <div class="col-sm-10">
        ...
        <label class="label_color"><input data-rule-required="true" data-msg-required="请填写肺部." type="radio" name="abdomen" vid="" alue="2" aria-required="true">&nbsp;异常</label><br />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 healthy pddright0" style="margin-top: 3px;">
            <label class="label_color"><input type="checkbox" data-rule-required="true" data-msg-required="请填写发育评估." name="grow_assessment[]" id="" value="1">不会表达自己的感受或想法</label>
            <label class="label_color"><input type="checkbox" data-rule-required="true" data-msg-required="请填写发育评估." name="grow_assessment[]" id="" value="2"> 不会玩角色扮演的集体游戏</label>
            <label class="label_color"><input type="checkbox" data-rule-required="true" data-msg-required="请填写发育评估." name="grow_assessment[]" id="" value="3">不会画方形</label>
            <label class="label_color"><input type="checkbox" data-rule-required="true" data-msg-required="请填写发育评估." name="grow_assessment[]" id="" value="4">不会奔跑</label>
        </div>
    </div>
</script>