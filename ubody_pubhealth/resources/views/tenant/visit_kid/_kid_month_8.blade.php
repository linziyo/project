<script type="text/template" id="kid_month_8">
    @include('tenant.visit_kid._guide_small')
</script>
<script type="text/template" id="kids_month_8">
    ...
    <div class="col-sm-10">
        ...
        <label class="label_color"><input data-rule-required="true" data-msg-required="请填写眼睛." type="radio" name="eye" value="2" aria-required="true">&nbsp;异常</label><br />
        ...
        <label>
            <input type="text" class="form-control" name="mouth" id=""/>
        </label>
        <label><p style="font-size: 16px;font-weight: initial;margin-right: 20px;">颗</p></label><br />
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 healthy pddright0" style="margin-top: 3px;">
            <label class="label_color"><input type="checkbox" data-rule-required="true" data-msg-required="请填写发育评估." name="grow_assessment[]" id="" value="1"> 听到声音无应答</label>
            <label class="label_color"><input type="checkbox" data-rule-required="true" data-msg-required="请填写发育评估." name="grow_assessment[]" id="" value="2">不会区分生人和熟人</label>
            <label class="label_color"><input type="checkbox" data-rule-required="true" data-msg-required="请填写发育评估." name="grow_assessment[]" id="" value="3">双手间不会传递玩具</label>
            <label class="label_color"><input type="checkbox" data-rule-required="true" data-msg-required="请填写发育评估." name="grow_assessment[]" id="" value="4">不会独坐</label>
        </div>
    </div>
</script>