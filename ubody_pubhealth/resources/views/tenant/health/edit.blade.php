...
@section('content')
    <form class="form-horizontal"
          id="formArchive" method="post" action="">
        {{csrf_field()}}
            ...
            <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    {!! Form::text('disease_confirmed_at', (isset($disease->confirmed_at)?$disease->confirmed_at:null), ['class'=>'form-control date', 'placeholder'=>'确诊时间', 'disabled'=>'disabled']) !!}
                ...
                <div class="form-group">
                    ...
                    <div id="injuryWrapper" class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    {!! Form::text('injury_confirmed_at', (isset($injurie->confirmed_at)?$injurie->confirmed_at:null), ['class'=>'form-control date','placeholder'=>'确诊时间','disabled'=>'disabled']) !!}
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-flat"><i class="fa fa-calendar"></i></button>
                                    </span>
                                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="operationWrapper" class="col-sm-6">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                {!! Form::text('operation_confirmed_at', (isset($operation->confirmed_at)?$operation->confirmed_at:null), ['class'=>'form-control date','placeholder'=>'确诊时间','disabled'=>'disabled']) !!}
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-flat"><i class="fa fa-calendar"></i></button>
                                </span>
                            </div>
                    ...
                    <div id="transfusionWrapper" class="col-sm-6">
                        @foreach($model->transfusions as $key=>$transfusion)
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        {!! Form::text('transfusion_confirmed_at', (isset($transfusion->confirmed_at)?$transfusion->confirmed_at:null), ['class'=>'form-control date','placeholder'=>'确诊时间','disabled'=>'disabled']) !!}
                                        <span class="input-group-btn">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <label class="checkbox-inline">
                            {!! Form::checkbox('hereditary_disease', 1, ($model->hereditaryDisease->value == 1)) !!} 无
                        </label>
                        <label class="checkbox-inline">
                            {!! Form::checkbox('hereditary_disease', 2, ($model->hereditaryDisease->value == 2)) !!} 有
                        </label>
                        <label class="checkbox-inline">
                            @if($model->hereditaryDisease->value == 2)
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-md-3">
                                {!! Form::select('living_kitchen',[''=>'厨房排风设施',1=>'无',2=>'油烟机',3=>'换气扇',4=>'烟囱'],$model->livingKitchen->value,['class'=>'form-control']) !!}
                            </div>
                            <div class="col-md-2">
                                {!! Form::select('living_fuel',[''=>'燃料类型',1=>'液化气',2=>'煤',3=>'天然气',4=>'沼气',5=>'柴火',6=>'其他'],$model->livingFuel->value,['class'=>'form-control']) !!}
                            </div>
                            <div class="col-md-2">
                                {!! Form::select('living_water',[''=>'饮水',1=>'自来水',2=>'经净化过滤的水',3=>'井水',4=>'河湖水',5=>'塘水',6=>'其他'],$model->livingWater->value,['class'=>'form-control']) !!}
                            </div>
                            <div class="col-md-3">
                                {!! Form::select('living_toilet',[''=>'厕所',1=>'卫生厕所',2=>'一格或二格粪池式',3=>'马桶',4=>'露天粪坑',5=>'简易棚厕'],$model->livingToilet->value,['class'=>'form-control']) !!}
                            </div>
                            <div class="col-md-2">
                                {!! Form::select('living_fence',[''=>'禽畜栏',1=>'无',2=>'单设',3=>'室内',4=>'室外'],$model->livingFence->value,['class'=>'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4"><span class="help-block"></span></div>
...
<script id="tplDisease" type="text/template">
    <div class="row">
        ...
        <div class="col-md-3">
            <input type="text" placeholder="疾病内容" name="disease_content" class="form-control"/>
        </div>
        <div class="col-md-4">
            <div class="input-group">
...
<script id="tplInjury" type="text/template">
    <div class="row">
        ...
        <div class="col-md-3">
            <input type="text" placeholder="名称" name="injury_content" class="form-control"/>
        </div>
        <div class="col-md-4">
            <div class="input-group">
...
<script id="tplOperation" type="text/template">
    <div class="row">
        ...
        <div class="col-md-3">
            <input type="text" placeholder="名称" name="operation_content" class="form-control"/>
        </div>
        <div class="col-md-4">
            <div class="input-group">
...
<script id="tplTransfusion" type="text/template">
    <div class="row">
        ...
        <div class="col-md-3">
            <input type="text" placeholder="名称" name="transfusion_content" class="form-control"/>
        </div>
        <div class="col-md-4">
            <div class="input-group">
...
<script id="tplFamily" type="text/template">
    <div class="row">
        ...
        <div class="col-md-4">
            <input type="text" placeholder="其他" name="family_content" class="form-control"/>
        </div>
        <div class="col-md-2">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("select[name=family_value]").change(function(){
            if($(this).val() == 12){
                $("input[name=family_content]").removeAttr('disabled');
            }else{
                $("input[name=family_content]").attr('disabled','disabled');
            }
        });
    });
</script>
